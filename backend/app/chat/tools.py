                    ...
                    "days": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "target_pace": {"type": ["string", "null"], "description": "min/km as 'M:SS' or the band 'M:SS-M:SS' (slower-faster); no units or words. Bands must be runnable: 20-30s/km wide for easy/long, at least 10s/km for quality"},
                                "target_hr_low": {"type": ["integer", "null"], "description": f"HR band lower bound (bpm); use per the athlete's training mode — never set both pace and HR. A band spans at least {metrics.MIN_HR_BAND_WIDTH} bpm, 15+ for easy/long"},
